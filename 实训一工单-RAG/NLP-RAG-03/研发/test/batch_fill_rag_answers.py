...
DEFAULT_INPUT = Path(r"D:\Desktop\NLP-RAG-03\reports\parse3\evaluation_result_template.csv")
DEFAULT_OUTPUT = Path(r"D:\Desktop\NLP-RAG-03\reports\parse3\evaluation_result.csv")
