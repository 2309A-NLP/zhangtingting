    ...
    data = [
        {
            ...
            "redaction_stats": page.get("redaction_stats", {"redacted": False, "replacements": 0, "entities": []}),
        }
        for page in pages
    ]
...
def write_pdf_vlm_failure(
    ...
    failure_path = output_path or (settings.artifact_dir / "pdf_vlm_last_failure.json")
